...
def create_argparser():
    ...
    parser.add_argument(
        "--prompt", type=str, 
        default="A vibrant illustration of a solitary cobalt blue dog donning elegant, vintage-inspired aviator sunglasses, in the style of abstract expressionism. It stands proudly atop a towering, windswept sand dune in a vast, otherworldly desert under a twilight sky filled with swirling, iridescent clouds on a misty, tranquil evening, holding a shimmering, jeweled scepter, surrounded by colossal, futuristic monoliths and ethereal, bioluminescent flora glowing mystically in the background.A watercolor of one cobalt blue dog in the style of abstract expressionism. It stands proudly on the towering, windswept sand dune in the vast, otherworldly desert on a misty evening, holding a shimmering, jeweled scepter, surrounded by colossal, futuristic monoliths and ethereal, bioluminescent flora glowing mystically in the background.",
