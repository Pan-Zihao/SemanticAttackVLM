...
def load_flow_model(name: str, device: str | torch.device = "cuda", hf_download: bool = True):
    ...
    if (
        ...
        ckpt_path ="/storage/panzihao/models/FLUX.1-dev/flux1-dev.safetensors"
...
def load_t5(device: str | torch.device = "cuda", max_length: int = 512) -> HFEmbedder:
    ...
    return HFEmbedder("/storage/panzihao/models/xflux_text_encoders", max_length=max_length, torch_dtype=torch.bfloat16).to(device)

def load_clip(device: str | torch.device = "cuda") -> HFEmbedder:
    return HFEmbedder("/storage/panzihao/models/clip-vit-large-patch14", max_length=77, torch_dtype=torch.bfloat16).to(device)
...
def load_ae(name: str, device: str | torch.device = "cuda", hf_download: bool = True) -> AutoEncoder:
    ...
    if (
        ...
        ckpt_path = "/storage/panzihao/models/FLUX.1-dev/ae.safetensors"
