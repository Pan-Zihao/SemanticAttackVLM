...
from x_flux.src.flux.modules.layers import (
...
from x_flux.src.flux.sampling import denoise, denoise_controlnet, get_noise, get_schedule, prepare, unpack
from x_flux.src.flux.util import (
    load_ae,
    load_clip,
    load_flow_model,
    load_t5,
...
class XFluxPipeline:
    def __init__(self, model_type, device, offload: bool = False):
        ...
        self.image_encoder_path = "/storage/panzihao/models/clip-vit-large-patch14"
    ...
    def set_ip(self, local_path: str = None, repo_id = None, name: str = None):
        ...
        # unpack checkpoint
        local_path="/storage/panzihao/models/flux-ip-adapter/flux-ip-adapter.safetensors"
